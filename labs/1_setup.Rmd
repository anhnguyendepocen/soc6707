...
author: "Monica Alexander^[Aspects of this lab were improved from input from Abtin Parnia.]"
date: "15/01/2021"
output: pdf_document
---
...
Read in the GSS csv file. Note that you will probably have to change the file path below depending on where you saved the gss file. If you are having trouble it may help to change your working directory. You can do this by going to Menu --> Session --> Set Working Directory...
...
3. Find the mean age of immigration (age_immigration) of respondents in the GSS
